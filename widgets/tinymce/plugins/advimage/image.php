						...
						<table class="properties">
							<tr>
								...
								<td colspan="2"><table border="0" cellspacing="0" cellpadding="0">
									<tr> 
									  <td><input name="src" type="text" id="fs_src" value="" class="mceFocus" onchange="ImageDialog.showPreviewImage(this.value);" /><button type="button" onclick="openFileSelectWindowUrl('fs_src');"><?php  echo _t("Browse or upload file"); ?></button></td> 
