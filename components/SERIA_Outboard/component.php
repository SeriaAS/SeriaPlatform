<?php
	...
	function so_guiembed($gui)
	{
		...
		$gui->addMenuItem('controlpanel/outboard/comments', _t("Comments"), _t("Commenting feature."), SERIA_HTTP_ROOT.'/seria/components/SERIA_Outboard/cp/comments.php');
...
//		$gui->addMenuItem('controlpanel/outboard/comments/edit', _t("Add comment"), _t("Add a new comment."), SERIA_HTTP_ROOT."/seria/components/SERIA_Outboard/cp/comments/edit.php");
		$gui->addMenuItem('controlpanel/outboard/ratings', _t("Ratings"), _t("Rating feature."), SERIA_HTTP_ROOT.'/seria/components/SERIA_Outboard/cp/ratings.php');
	}
