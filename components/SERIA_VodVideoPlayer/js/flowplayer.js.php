...
//alert(this.duration + "=" + duration);
	...
	remote: 'http://<?php echo $_SERVER['HTTP_HOST']; ?>/?route=seria%2Fvodvideoplayer%2Fflowplayer&objectKey=' + this.objectKey + '<?php echo $optionString; ?>',
...
(function(){
	...
	if(SeriaPlayerClass.allIndex==0) {
		LazyLoader.load(SERIA_VARS.HTTP_ROOT + '/seria/components/SERIA_VodVideoPlayer/js/easyXDM.min.js', function() {
