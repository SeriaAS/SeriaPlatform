...
$settings = '{
	...
	clip: {
		...
		scaling: "stretch",
//		url: "manifest.f4m",
		url: '.json_encode(substr($streamInfo['sources']['rtmp_low']['urls'][0], strrpos($streamInfo['sources']['rtmp_low']['urls'][0], "/")+1)).',
		live: true,
//		baseUrl: '.json_encode(substr($streamInfo['sources']['sanjose_auto']['url'], 0, strpos($streamInfo['sources']['sanjose_auto']['url'], "manifest.f4m"))).',
...
//		provider: "httpstreaming",
	...
	plugins: {
		...
		rtmp: {
			url: SERIA_VARS.HTTP_ROOT + "/seria/components/SERIA_LiveVideoPlayer/bin/flowplayer/flowplayer.rtmp-3.2.10.swf",
			netConnectionUrl: "rtmp://streaming.seria.net/direct",
		},
/*
		httpstreaming: {
			url: SERIA_VARS.HTTP_ROOT + "/seria/components/SERIA_LiveVideoPlayer/bin/flowplayer.httpstreaming-3.2.8.swf"
		},
		f4m: {
			url: SERIA_VARS.HTTP_ROOT + "/seria/components/SERIA_LiveVideoPlayer/bin/flowplayer.f4m-3.2.9.swf"
		},
		bwcheck: {
			dynamic: true,
			url: SERIA_VARS.HTTP_ROOT + "/seria/components/SERIA_LiveVideoPlayer/bin/flowplayer.bwcheck-httpstreaming-3.2.9.swf",
			checkOnStart: true
		},
*/
		controls: null,
		content: {
			url: SERIA_VARS.HTTP_ROOT + "/seria/components/SERIA_LiveVideoPlayer/bin/flowplayer/flowplayer.content-3.2.8.swf",
