...
SeriaPlayerClass.prototype = {
	...
	remote: 'http://<?php echo $_SERVER['HTTP_HOST']; ?>/?route=seria%2Flivevideoplayer%2Fflowplayer&objectKey=' + this.objectKey + '<?php echo $optionString; ?>',
...
//		else alert("this['on' + " + name + "] not found");
	},
	play : function() {
...
(function(){
	...
	if(SeriaPlayerClass.allIndex==0) {
		LazyLoader.load(SERIA_VARS.HTTP_ROOT + '/seria/components/SERIA_LiveVideoPlayer/js/easyXDM.min.js', function() {
