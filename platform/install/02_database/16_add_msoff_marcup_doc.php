...
$filetypes = array(
	array('Word Microsoft Office Open XML Format Document with Macros Enabled',	'application/vnd.ms-word.document.macroEnabled.12',	'docm', 'Word Microsoft Office Åpen XML Dokument med Makroer', 'textdocs', null)
);
